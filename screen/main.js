...
const { app, BrowserWindow, ipcMain, contentTracing, Notification, net, netLog, protocol, screen } = require('electron');
...
app.on('ready', () => {
	...
	debug('displays: %o', displays);
	const notification1 = new Notification({
		title: '显示器数量',
		body: `你有${displays.length}块显示器`
	});
	notification1.show();
